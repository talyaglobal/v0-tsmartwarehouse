...
interface StaffProposeTimeModalProps {
  open: boolean
...
export function StaffProposeTimeModal({
  open,
  onOpenChange,
  warehouse,
  bookingId,
  ...
  const loadTimeSlotsForDate = async (date: string) => {
    ...
    try {
      ...
      console.error("[StaffProposeTimeModal] Error loading time slots:", error)
      setSelectedTime("")
      // Update day availabilities with empty slots to show error state
      setDayAvailabilities((prev) =>
        prev.map((day) =>
  ...
  const handleConfirm = async () => {
    ...
    try {
      const result = await api.post(
        ...
        {
          successMessage: "Date/time change proposed successfully. Customer will be notified.",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Set Another Time and Date</DialogTitle>
          <DialogDescription>
                ...
                <div className="pt-4 border-t">
                  ...
                  <Alert>
                    ...
                    <AlertDescription className="text-xs">
                      The customer will be notified about this proposed date and time. They can accept it or request a different time.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
