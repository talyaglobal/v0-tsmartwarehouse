...
export default function WarehouseChatsPage() {
  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      <div className={cn("grid gap-4", "grid-cols-1 md:grid-cols-[320px_1fr]")}>
        <Card className="flex flex-col min-h-[400px] md:h-[calc(100vh-14rem)]">
          ...
          {conversationsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center flex-1 p-4 text-center text-muted-foreground text-sm">
              ...
              <p className="mt-1">Clients can start a chat from their booking.</p>
            </div>
          ) : (
                ...
                {conversations.map((conv) => {
                  ...
                  const otherName =
                    user?.id === conv.guest_id
                      ...
                      : conv.guest_name || conv.warehouse_name || "Client"
                  return (
                    <li key={conv.id}>
                      <button
                        type="button"
            ...
            <>
              <div className="p-3 border-b flex items-center gap-2">
                ...
                <span className="font-medium">
                  {selectedConversation?.guest_name || selectedConversation?.warehouse_name || "Chat"}
                </span>
              </div>
