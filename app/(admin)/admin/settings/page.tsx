            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="company-name" defaultValue="TSmart Warehouse" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="company-email">Contact Email</Label>
                  <Input id="company-email" type="email" defaultValue="contact@tsmartwarehouse.com" />
                </div>
                <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Get notified when new bookings are created</p>
                </div>
                <Switch defaultChecked />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Immediate alerts for reported incidents</p>
                </div>
                <Switch defaultChecked />
              </div>
              <Separator />
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="late-fee" type="number" defaultValue="1.5" />
                </div>
              </div>
              <Separator />
              <div className="flex justify-end">
