...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(root, 'supabase', 'migrations', '096_verify_warehouse_services_schema.sql');
    ...
    console.log('📄 Running migration: Verify warehouse_services schema (096_verify_warehouse_services_schema.sql)...\n');

    await client.query(migrationSQL);
    console.log('✅ Migration 096 applied successfully!');
    console.log('   warehouse_services table schema verified and fixed.');
