...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(root, 'supabase', 'migrations', '098_make_code_nullable_in_warehouse_services.sql');
    ...
    console.log('📄 Running migration: Make code nullable in warehouse_services (098_make_code_nullable_in_warehouse_services.sql)...\n');

    await client.query(migrationSQL);
    console.log('✅ Migration 098 applied successfully!');
    console.log('   code column is now nullable in warehouse_services table.');
