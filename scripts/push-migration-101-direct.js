...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(root, 'supabase', 'migrations', '101_update_ports_to_jsonb.sql');
    ...
    console.log('📄 Running migration: Update ports to JSONB (101_update_ports_to_jsonb.sql)...\n');

    await client.query(migrationSQL);
    console.log('✅ Migration 101 applied successfully!');
    console.log('   Updated ports structure to JSONB array.');
